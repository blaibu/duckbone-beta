...
<%= application_name %>.Views.<%= class_name.pluralize %>Item = Duckbone.View.extends({
...
<%= application_name %>.Views.<%= class_name.pluralize %>List = Duckbone.ListView.extends({
  tagName: 'tbody',
  viewClass: <%= application_name %>.Views.<%= class_name.pluralize %>Item
});

// The index view itself, which hosts the list view
<%= application_name %>.Views.<%= class_name.pluralize %>Index = Duckbone.View.extends({
